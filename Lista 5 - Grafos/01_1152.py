...
# O objetivo do codigo e encontrar quantos pesos serao "economizados" no total. Para isso, foi calculado o
# total de pesos das arestas do grafo e, posteriormente, subtraido o valor total dos pesos da arvore geradora
# minima. Esse custo foi calculado dentro do algotitmo de prim que trabalha com listas de prioridade. Ele visita
# os caminhos atraves dessa lista e, portanto, consegue trabalhar com os caminhos que possuem um peso menor.
# **********************************************************************************************************
